/**
 * Модуль «Экран выбора исполнителя»
 * @module screen/level-artist
 */
...
const initControls = (screen) => {
  const answers = Array.from(screen.querySelectorAll(`.main-answer`));
...
export default new Screen(`<section class="main main--level main--level-artist">
